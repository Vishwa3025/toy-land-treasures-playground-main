...
//         <div className="absolute top-32 right-20 text-3xl animate-float">🚀</div>
...
//           {/* Hero Content */}
//           <div className="text-center lg:text-left">
//             <div className="hidden md:block flex items-center justify-center lg:justify-start mb-6">
//               <div className="flex items-center bg-primary/10 rounded-full px-4 py-2 hover-bounce">
//                 <Star className="w-5 h-5 text-toy-yellow mr-2 animate-spin-slow" />
//                 <span className="text-primary font-baloo font-semibold">Magical Toys Await!</span>
//               </div>
...
//             {/* Banner Carousel */}
//             <div className="relative w-full max-w-xl mx-auto lg:mx-0 mb-8">
//               <div className="overflow-hidden rounded-2xl shadow-lg">
//                 <div className="flex animate-slide-carousel">
//                   <img src={banner1} alt="Banner 1" className="w-full flex-shrink-0 object-fit h-48 sm:h-60 md:h-72 lg:h-80" />
//                   <img src={banner2} alt="Banner 2" className="w-full flex-shrink-0 object-fit h-48 sm:h-60 md:h-72 lg:h-80" />
//                   <img src={banner3} alt="Banner 3" className="w-full flex-shrink-0 object-fit h-48 sm:h-60 md:h-72 lg:h-80" />
//                 </div>
//               </div>
//             </div>
...
//               <Button variant="outline" size="lg" className="hidden md:block font-baloo font-semibold">
//                 Explore Categories
//               </Button>
//             </div>
...
//           width: 300%;
//           animation: slide-carousel 12s infinite;
//         }
//       `}</style>
//     </section>
//   );
      ...
      <div className="w-full h-full overflow-hidden">
        <div className="flex animate-slide-carousel">
          <img
            src={banner1}
            alt="Banner 1"
            className="w-full flex-shrink-0 object-cover h-[60vh] sm:h-[70vh] lg:h-[80vh]"
          />
          <img
            src={banner2}
            alt="Banner 2"

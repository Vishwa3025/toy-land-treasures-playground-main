    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-grow py-20 bg-background">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="rounded-3xl p-10 shadow-lg toy-shadow space-y-12">

            {/* Header */}
            <div className="flex flex-col items-center text-center mb-8">
              <Shield className="w-12 h-12 text-primary mb-4" />
              <h2 className="text-3xl font-baloo font-bold text-primary">
                Easy, Transparent & Fair
              </h2>
              <p className="text-foreground font-poppins mt-2 max-w-2xl">
            ...
            <div className="space-y-12 text-left">
              ...
              <section>
                ...
                <p className="text-foreground font-poppins leading-relaxed">
                  You have <span className="font-semibold text-nuted-foreground">3 days</span> from the delivery date to request a return or exchange.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-foreground font-poppins leading-relaxed space-y-2">
              ...
              {/* Exchanges */}
              <section>
                <h3 className="text-2xl font-baloo font-bold text-primary mb-3">🔁 Exchanges</h3>
                <p className="text-foreground font-poppins leading-relaxed">
              ...
              {/* Return Shipping */}
              <section>
                <h3 className="text-2xl font-baloo font-bold text-primary mb-3">💸 Return Shipping</h3>
                <p className="text-foreground font-poppins leading-relaxed">
              ...
              <section>
                ...
                <ol className="list-decimal list-inside text-foreground font-poppins leading-relaxed space-y-2">
                  <li>
                    Email us at{" "}
              ...
              {/* Contact */}
              <section>
                <h3 className="text-2xl font-baloo font-bold text-primary mb-3">☎️ Contact Us</h3>
                <p className="text-foreground font-poppins leading-relaxed">
                ...
                <div className="space-y-3 mt-4">
                  <div className="flex items-center">
                    ...
                    <a href="mailto:support@fstoysfactory.com" className="underline text-foreground hover:text-accent transition-colors">
                      support@fstoysfactory.com
                    </a>
                  </div>
                  <div className="flex items-center">
                    <Phone className="w-5 h-5 mr-2 text-primary" />
                    <a href="tel:+9197338942533" className="underline text-foreground hover:text-accent transition-colors">
                      +91-7338942533
                    </a>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 via-toy-yellow/10 to-accent/10 text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl text-foreground max-w-2xl mx-auto font-poppins leading-relaxed">

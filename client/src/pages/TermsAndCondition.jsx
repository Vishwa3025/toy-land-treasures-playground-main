...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="py-24 bg-gradient-to-br from-black via-black to-primary text-center">
        <div className="container mx-auto px-6 py-5">
          ...
          <p className="text-xl text-foreground max-w-3xl mx-auto font-poppins leading-relaxed">
            Welcome to <span className="font-semibold text-foreground">FS Toys Factory</span>!  
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="rounded-3xl p-12 space-y-16">
            ...
            <div className="px-20 space-y-12">
              ...
              {/* Payments */}
              <section className="space-y-4">
                <h3 className="text-2xl font-baloo font-bold text-primary">💳 Payments</h3>
                <p className="text-foreground font-poppins leading-relaxed">
              ...
              <section className="space-y-4">
                ...
                <p className="text-foreground font-poppins leading-relaxed">
                  ...
                  belongs to <span className="font-semibold text-foreground">FS Toys Factory</span> and cannot be copied or reused  
      ...
      <section className="py-24 bg-gradient-to-r from-primary/10 via-toy-yellow/10 to-accent/10 text-center">
        <div className="container mx-auto px-6 py-8">
          ...
          <p className="text-xl text-foreground max-w-2xl mx-auto font-poppins leading-relaxed">
            ...
            Thank you for trusting FS Toys Factory!
          </p>
        </div>
      </section>
